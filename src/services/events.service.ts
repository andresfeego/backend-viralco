...
const RESOURCE_PURPOSES = new Set(['frame', 'sticker', 'overlay', 'intro', 'outro', 'music', 'logo', 'background', 'template', 'branding', 'start_screen', 'animation', 'gif_overlay', 'font', 'other']);
